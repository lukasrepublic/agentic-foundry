...
**Status: v1.11.0.** Built solo, dogfooded daily — Foundry is built *with* Foundry: every release
...
That's the whole discipline. The other ~62 skills are an **optional catalog** — release-wave
...
More than 1900 pytest tests · doctor green in under a second · every third-party GitHub Action
