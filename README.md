...
**Status: v1.4.1.** Built solo, dogfooded daily — Foundry is built *with* Foundry: every release
...
```bash
claude plugin marketplace add lukasrepublic/agentic-foundry#v1.4.1
