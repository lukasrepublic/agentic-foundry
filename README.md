...
**Status: v1.2.2.** Built solo, dogfooded daily — Foundry is built *with* Foundry: every release
...
```bash
claude plugin marketplace add lukasrepublic/agentic-foundry#v1.2.2
